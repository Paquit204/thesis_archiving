    ...
    <div class="main-content">
        ...
        <div class="faculty-section">
            <div class="section-header">
                ...
                <a href="faculty.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="faculty-grid">
                ...
                <div class="faculty-card">
                    ...
                    <div class="faculty-stats">
                        ...
                        <div class="faculty-stat">
                            <div class="faculty-stat-value"><span class="status-badge <?php echo $faculty['status']; ?>"><?php echo ucfirst($faculty['status']); ?></span></div>
        ...
        <div class="projects-section">
            <div class="section-header">
                ...
                <a href="projects.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="table-responsive">
                <table>
                    <thead><tr><th>PROJECT TITLE</th><th>STUDENT</th><th>ADVISER</th><th>DEFENSE DATE</th><th>STATUS</th><th>ACTION</th></tr></thead>
                    <tbody>
        ...
        <div class="defenses-section">
            <div class="section-header">
                ...
                <a href="defenses.php" class="view-all">Schedule New <i class="fas fa-plus"></i></a>
            </div>
        ...
        <div class="bottom-grid">
            ...
            <div class="workload-section">
                <div class="section-header"><h2 class="section-title">Faculty Workload Summary</h2><a href="reports.php" class="view-all">Details <i class="fas fa-arrow-right"></i></a></div>
        ...
        <div class="quick-actions">
            <a href="defenses.php" class="quick-action-btn"><i class="fas fa-calendar-plus"></i><span>Schedule Defense</span></a>
            <a href="reports.php" class="quick-action-btn"><i class="fas fa-file-pdf"></i><span>Department Report</span></a>
            <a href="reports.php" class="quick-action-btn"><i class="fas fa-chart-line"></i><span>View Analytics</span></a>
            <a href="faculty.php" class="quick-action-btn"><i class="fas fa-user-plus"></i><span>Add Faculty</span></a>
    ...
    <script>
        new Chart(document.getElementById('projectStatusChart'), {
            ...
            options: {
                ...
                plugins: { legend: { position: 'bottom', labels: { padding: 20, usePointStyle: true, pointStyle: 'circle', color: '#333' } } },
                cutout: '70%'
            }
        });
