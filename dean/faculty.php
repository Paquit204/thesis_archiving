...
$faculty_members = [
    ['id' => 1, 'name' => 'Prof. Juan Dela Cruz', 'specialization' => 'Computer Science', 'projects_supervised' => 8, 'status' => 'active', 'email' => 'juan.dc@cas.edu', 'phone' => '123-4567'],
    ['id' => 2, 'name' => 'Dr. Ana Lopez', 'specialization' => 'Mathematics', 'projects_supervised' => 6, 'status' => 'active', 'email' => 'ana.lopez@cas.edu', 'phone' => '123-4568'],
    ['id' => 3, 'name' => 'Prof. Pedro Reyes', 'specialization' => 'Physics', 'projects_supervised' => 4, 'status' => 'active', 'email' => 'pedro.reyes@cas.edu', 'phone' => '123-4569'],
    ['id' => 4, 'name' => 'Dr. Lisa Garcia', 'specialization' => 'Chemistry', 'projects_supervised' => 5, 'status' => 'on-leave', 'email' => 'lisa.garcia@cas.edu', 'phone' => '123-4570'],
    ['id' => 5, 'name' => 'Prof. Mark Santiago', 'specialization' => 'Biology', 'projects_supervised' => 7, 'status' => 'active', 'email' => 'mark.santiago@cas.edu', 'phone' => '123-4571'],
    ['id' => 6, 'name' => 'Dr. Karen Villanueva', 'specialization' => 'Literature', 'projects_supervised' => 3, 'status' => 'active', 'email' => 'karen.v@cas.edu', 'phone' => '123-4572'],
    ['id' => 7, 'name' => 'Prof. Michael Sy', 'specialization' => 'History', 'projects_supervised' => 2, 'status' => 'active', 'email' => 'michael.sy@cas.edu', 'phone' => '123-4573'],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_faculty'])) {
    ...
    if (empty($name) || empty($specialization) || empty($email)) {
        $add_message = '<span style="color: red;">All fields except phone are required.</span>';
    } elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $add_message = '<span style="color: red;">Invalid email format.</span>';
    } else {
        $add_message = '<span style="color: green;">Faculty added successfully (demo).</span>';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Faculty Management | Dean</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        /* Copy all CSS from dean.php here – exactly the same */
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .nav-menu { flex: 1; }
        .nav-item { display: flex; align-items: center; padding: 12px 25px; margin: 5px 10px; border-radius: 12px; color: #ffebee; transition: all 0.3s ease; cursor: pointer; text-decoration: none; }
        ...
        .form-container { background: white; border-radius: 20px; padding: 25px; margin-top: 30px; border: 1px solid #ffcdd2; }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dept-banner">
            <div class="dept-info"><h1>Faculty Management</h1><p><?php echo $department; ?></p></div>
        ...
        <div class="faculty-section" style="margin-top:20px;">
            ...
            <div class="table-responsive">
                <table>
                    <thead><tr><th>Name</th><th>Specialization</th><th>Email</th><th>Phone</th><th>Projects</th><th>Status</th><th>Action</th></tr></thead>
                    <tbody>
