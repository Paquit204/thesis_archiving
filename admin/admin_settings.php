...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_settings'])) {
    ...
    if (empty($inst_name) || empty($admin_name) || empty($admin_email)) {
        $settings_message = '<span style="color: red;">Institution name, admin name, and email are required.</span>';
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dept-banner">
            <div class="dept-info"><h1>System Settings</h1><p><?php echo $institution; ?></p></div>
        ...
        <div class="settings-grid">
            ...
            <div class="form-container">
                <h3 style="margin-bottom:20px; color:#333;">Institution Information</h3>
                <?php if ($settings_message): ?><div class="message"><?php echo $settings_message; ?></div><?php endif; ?>
                <form method="post">
                    <div class="form-group">
                        <label>Institution Name *</label>
                        <input type="text" name="inst_name" value="<?php echo htmlspecialchars($institution); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Admin Full Name *</label>
                        <input type="text" name="admin_name" value="<?php echo htmlspecialchars($user_name); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Admin Email *</label>
                        <input type="email" name="admin_email" value="<?php echo htmlspecialchars($user_email); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Phone</label>
                        <input type="text" name="phone" value="(02) 1234-5678">
                    </div>
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" name="address" value="Main Campus">
                    </div>
        ...
        <div class="form-container" style="margin-top:25px;">
            <h3 style="margin-bottom:20px; color:#333;">Notification Preferences</h3>
