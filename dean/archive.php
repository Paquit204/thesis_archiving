...
$archived = array_filter($department_projects, fn($p) => $p['status'] == 'archived');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Archived Projects | ThesisManager</title>
...
<body>
    ...
    <div class="main-content">
        <!-- TOP BAR -->
        <div class="top-bar">
            <div class="search-area"><i class="fas fa-search"></i><input type="text" placeholder="Search archive..."></div>
        ...
        <div class="dept-banner">
            <div class="dept-info"><h1>Archived Projects</h1><p><?php echo $department; ?></p></div>
        ...
        <div class="projects-section">
            <div class="section-header">
                <h2 class="section-title">Archived Theses & Projects</h2>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($archived as $project): ?>
                        <tr>
                            <td><?php echo $project['title']; ?></td>
                            <td><?php echo $project['student']; ?></td>
                            <td><?php echo $project['adviser']; ?></td>
                            <td><?php echo date('M d, Y', strtotime($project['submitted'])); ?></td>
                            <td>
                                <?php if ($project['defense_date']): ?>
                                    <span class="defense-date"><i class="far fa-calendar-alt"></i> <?php echo date('M d, Y', strtotime($project['defense_date'])); ?></span>
                                <?php else: ?>
                        ...
                        <tr><td colspan="7" style="text-align:center;">No archived projects found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
