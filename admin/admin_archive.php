...
// Dummy projects data (same as in admin_projects.php)
$projects = [
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dept-banner">
            <div class="dept-info"><h1>Archived Projects</h1><p><?php echo $institution; ?></p></div>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="8" style="text-align:center; padding:30px;">No archived projects found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
