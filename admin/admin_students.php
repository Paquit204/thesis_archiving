...
$students = [
    ['id'=>1,'name'=>'Maria Santos','program'=>'BS CS','year'=>4,'project_title'=>'AI Thesis','adviser'=>'Prof. Dela Cruz','status'=>'ongoing','department'=>'CAS'],
    ['id'=>2,'name'=>'Juan Dela Cruz','program'=>'BS IT','year'=>4,'project_title'=>'Mobile App','adviser'=>'Dr. Lopez','status'=>'ongoing','department'=>'CAS'],
    ['id'=>3,'name'=>'Ana Lopez','program'=>'BS Math','year'=>4,'project_title'=>'E-Learning','adviser'=>'Prof. Reyes','status'=>'completed','department'=>'CAS'],
    ['id'=>4,'name'=>'Pedro Reyes','program'=>'BS Physics','year'=>4,'project_title'=>'IoT','adviser'=>'Dr. Garcia','status'=>'pending','department'=>'CAS'],
    ['id'=>5,'name'=>'Lisa Garcia','program'=>'BS Chem','year'=>4,'project_title'=>'Blockchain','adviser'=>'Prof. Santiago','status'=>'archived','department'=>'CAS'],
    ['id'=>6,'name'=>'Mark Santiago','program'=>'BS Biology','year'=>4,'project_title'=>'VR Tour','adviser'=>'Dr. Villanueva','status'=>'ongoing','department'=>'CAS'],
    ['id'=>7,'name'=>'Karen Villanueva','program'=>'BS Lit','year'=>4,'project_title'=>'Grading System','adviser'=>'Prof. Dela Cruz','status'=>'pending','department'=>'CAS'],
];
...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Inter',sans-serif; }
        ...
        .status-dot.ongoing { background:#d32f2f; box-shadow:0 0 0 3px rgba(211,47,47,0.2); }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dept-banner">
            <div class="dept-info"><h1>Student Management</h1><p><?php echo $institution; ?></p></div>
        ...
        <div class="projects-section">
            <div class="section-header"><h2 class="section-title">All Students</h2><a href="#" class="view-all">Export <i class="fas fa-download"></i></a></div>
            <div class="table-responsive">
                <table>
                    <thead><tr><th>Name</th><th>Program</th><th>Year</th><th>Project Title</th><th>Adviser</th><th>Department</th><th>Status</th><th>Action</th></tr></thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="status">
                                    <span class="status-dot <?php echo $s['status'] == 'ongoing' ? 'in-progress' : $s['status']; ?>"></span>
                                    <span class="status-text"><?php echo ucfirst($s['status']); ?></span>
                                </div>
                            </td>
